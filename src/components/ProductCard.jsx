...
const ProductCard = ({ query, setQueries, queries }) => {
  ...
  return (
    <div className="">
      <div className="group hover:saturate-100 saturate-0 rounded-xl transition-[filter] relative bg-blue-100 dark:bg-gray-800 dark:text-white font-['Robot_Flex'] border-b-2 lg:p-5 md:p-3 p-5 border-b-blue-800">
        <img
        ...
        <div className="space-x-3 mt-3">
          ...
          <Link to={`/update/${_id}`}>
            <button className="px-4 py-2 font-serif hover:text-white hover:bg-blue-500 mb-2 border-gray-700 rounded-xl text-lg border">
              Update
            </button>
          </Link>
          <button
